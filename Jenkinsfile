pipeline {
    ...
    steps {
        script {
            def jenkinsUrl = 'http://18.133.237.165:8080/job/simplewebsite/33/input/Proceed%20or%20Abort/proceedEmpty?token=approval-117648386301641d5cc2833f83a71b43b8'
